...
TTI.winners = [];
    ...
    self.url = function() {
      return 'core/images/pci-curves/' + spec.filename;
    };
...
TTI.lookupBenefit = function(surfaceType,distress,treatment) {
  ...
  TTI.Image = function(spec) {
    ...
    self.url = function() {
      return 'implementors responsibility';//////////core/images/distresses/' + spec.filename;
    };
  ...
  TTI.DistressImage = function(spec) {
    var self = TTI.Image(spec);
    self.url = function() {
      return 'core/images/distresses/' + spec.filename;
    };

    ...
    (function (Acrp) {
        var App = (function () {
            ...
            App.initialize = function () {
                App.states = new Acrp.States("core/data/ClimaticZones.csv", function () {
                    populateStatesList();
                    App.downloadJson("core/data/asphalt.json", function (items) {
                        createRemediations(items, Acrp.SurfaceMaterial.Asphalt);
                        App.downloadJson("core/data/concrete.json", function (items) {
